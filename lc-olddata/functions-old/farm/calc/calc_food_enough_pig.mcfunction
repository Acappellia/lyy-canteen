...
execute if score #farm_animal_growth lc_var >= #farm_grow_time lc_var run data modify block 0 2 0 Items[{Slot:11b}].tag merge value {is_adult:1, CustomModelData:2}
...
execute if score #farm_animal_growth lc_var >= #farm_grow_time lc_var run data modify block 0 2 0 Items[{Slot:12b}].tag merge value {is_adult:1, CustomModelData:2}
...
execute if score #farm_animal_growth lc_var >= #farm_grow_time lc_var run data modify block 0 2 0 Items[{Slot:13b}].tag merge value {is_adult:1, CustomModelData:2}

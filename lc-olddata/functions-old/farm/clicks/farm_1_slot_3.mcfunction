##called when clicked 3rd slot in farm 1

##clone to tmp storage
data modify storage lc:var farm_var set from storage lc:user farm[0].farm_page_1[{Slot:13b}]
...
##clone back
data modify storage lc:user farm[0].farm_page_1[{Slot:13b}] set from storage lc:var farm_var

...
##play song
execute if score $out random matches 1 run playsound minecraft:bgm1 record @s
...
execute if score $out random matches 2 run playsound minecraft:bgm2 record @s
...
execute if score $out random matches 3 run playsound minecraft:bgm3 record @s
...
execute if score $out random matches 4 run playsound minecraft:bgm4 record @s
...
execute if score $out random matches 5 run playsound minecraft:bgm5 record @s
...
execute if score $out random matches 6 run playsound minecraft:bgm6 record @s
...
execute if score $out random matches 7 run playsound minecraft:bgm7 record @s
...
execute if score $out random matches 8 run playsound minecraft:bgm8 record @s
...
execute if score $out random matches 9 run playsound minecraft:bgm9 record @s
...
execute if score $out random matches 10 run playsound minecraft:bgm10 record @s
...
execute if score $out random matches 11 run playsound minecraft:bgm11 record @s
...
execute if score $out random matches 12 run playsound minecraft:bgm12 record @s
...
execute if score $out random matches 13 run playsound minecraft:bgm13 record @s

...
execute if score @s player_tp_energy < #player_tp_cost lc_var run tellraw @s [{"text": "> 进入隙间需消耗 ","color": "#CCCCCC"},{"score":{"name": "#player_tp_cost","objective": "lc_var"},"color": "white"},{"text": " 能量，当前能量不足","color": "#CCCCCC"}]
...
##prepare tp
tellraw @s [{"text": "> 进入隙间需消耗 ","color": "#CCCCCC"},{"score":{"name": "#player_tp_cost","objective": "lc_var"},"color": "white"},{"text": " 能量，快速再次点击以确认","color": "#CCCCCC"}]

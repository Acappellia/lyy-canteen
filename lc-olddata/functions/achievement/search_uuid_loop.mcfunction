...
data modify storage lc:user achievement append from storage lc:user achievement[0]
data remove storage lc:user achievement[0]
...
##loop
function lc:achievement/search_uuid_loop
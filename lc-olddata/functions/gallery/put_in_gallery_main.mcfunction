...
##put item into slot
data modify block 0 2 0 Items append value {Slot:9b,id:"minecraft:barrier",Count:1b,tag:{menu_ui:1,display:{Name:'{"text":"未学习的标准料理","color":"#00FFAA","italic":false}',Lore:['{"text":"继续探索，寻找这道料理的配方吧！","color":"gray"}']}}}
...
data modify block 0 2 0 Items[{Slot:9b}].tag.out_display.tag.display.Lore prepend value '{"text":"新获得！","color":"#A0FF50","bold":true}'

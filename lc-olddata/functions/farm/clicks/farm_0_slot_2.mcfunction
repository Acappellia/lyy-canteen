##called when clicked 2nd slot in farm 0

##clone to tmp storage
data modify storage lc:var farm_var set from storage lc:user farm[0].farm_page_0[{Slot:12b}]
...
##clone back
data modify storage lc:user farm[0].farm_page_0[{Slot:12b}] set from storage lc:var farm_var

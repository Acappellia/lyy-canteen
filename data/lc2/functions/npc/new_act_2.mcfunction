...
execute store result score @s p_state_withitem run data modify storage lc2:tmp npc_info.withitem set value 0
execute if score #npc_check_handitemid lc_var = #npc_check_stateitemid lc_var store result score @s p_state_withitem run data modify storage lc2:tmp npc_info.withitem set value 1
...
##play dialogue
execute if score #npc_check_handitemid lc_var = #npc_check_stateitemid lc_var run function lc2:npc/play_dialogue with storage lc2:tmp npc_info
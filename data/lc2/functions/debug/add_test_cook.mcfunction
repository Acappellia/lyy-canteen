...
give @a sugar{ismaterial:1,primep:2,display:{Name:'"白砂糖"'}} 64
give @a sugar{ismaterial:1,primep:3,display:{Name:'"盐"'}} 64
give @a apple{ismaterial:1,primep:5,display:{Name:'"大苹果"'}} 64
give @a carrot{ismaterial:1,primep:7,display:{Name:'"大萝卜"'}} 64
give @a iron_shovel{isspoon:1,display:{Name:'"铁勺"'}} 
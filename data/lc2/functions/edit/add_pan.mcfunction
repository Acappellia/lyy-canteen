...
##summon interaction
execute align xz positioned ~0.5 ~0 ~0.5 run kill @e[type=interaction,distance=..1,tag=pan]
execute align xz positioned ~0.5 ~0 ~0.5 run summon interaction ~ ~ ~ {Tags:["pan"],response:1b}
scoreboard players set @e[distance=..1,tag=pan,type=interaction] cook_status 0

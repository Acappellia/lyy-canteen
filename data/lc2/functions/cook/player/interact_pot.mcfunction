...
##cook qte
execute if score #cook_status lc_var matches 2 if data storage lc2:tmp p_hand.tag.isspoon as @e[type=interaction,distance=..1,tag=interact_target,tag=pot] run function lc2:cook/qte/start_qte
execute if score #cook_status lc_var matches 2 if data storage lc2:tmp p_hand.tag.isshovel as @e[type=interaction,distance=..1,tag=interact_target,tag=pan] run function lc2:cook/qte/start_qte
execute if score #cook_status lc_var matches 2 if data storage lc2:tmp p_hand.tag.isfork as @e[type=interaction,distance=..1,tag=interact_target,tag=grill] run function lc2:cook/qte/start_qte

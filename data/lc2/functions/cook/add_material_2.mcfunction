...
##add text display
summon text_display ~ ~ ~ {Tags:["pot_text_display_name"],transformation:[5,0,0,0,0,5,0,3,0,0,5,0,0,0,0,10],view_range:0.16f,billboard:"vertical",background:0,text:'[{"text": "物品","color": "dark_green"}]'}

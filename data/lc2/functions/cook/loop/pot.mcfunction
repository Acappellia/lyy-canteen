...
##qte particle
execute if score @s cook_status matches 2..3 run particle note ~ ~1.2 ~ 0.3 0.1 0.3 0 5
...
execute if score @s cook_time_dif matches -25..-11 run particle cloud ~ ~1 ~ 0.3 0.1 0.3 0 5
execute if score @s cook_time_dif matches -60..-26 run particle campfire_cosy_smoke ~ ~1 ~ 0.3 0.1 0.3 0 5
execute if score @s cook_time_dif matches ..-61 run particle squid_ink ~ ~1 ~ 0.3 0.1 0.3 0 5

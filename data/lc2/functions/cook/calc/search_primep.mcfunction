...
#define score_holder #check_dupe_result
...
execute if score #search_check lc_var = #cook_search_primep lc_var unless score #check_dupe_result lc_var matches -1 run return 2

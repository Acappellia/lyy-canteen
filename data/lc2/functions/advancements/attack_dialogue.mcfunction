...
advancement revoke @s only lc2:attack_dialogue
...
execute as @e[distance=..5,type=interaction,tag=dialogue] store result score @s interact_time run data get entity @s attack.timestamp

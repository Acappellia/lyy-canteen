...
advancement revoke @s only lc2:interact_deco
...
execute as @e[distance=..5,type=interaction,tag=deco] store result score @s interact_time run data get entity @s interaction.timestamp
...
execute at @e[distance=..5,type=interaction,tag=interact_target,tag=deco,limit=1] run function lc2:decoration/player_interact

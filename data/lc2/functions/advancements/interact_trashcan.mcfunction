...
advancement revoke @s only lc2:interact_trashcan
...
execute at @e[distance=..5,type=interaction,tag=trashing,tag=trashcan,limit=1] run function lc2:trashcan/trash

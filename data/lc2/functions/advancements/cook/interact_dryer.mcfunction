...
advancement revoke @s only lc2:cook/interact_dryer
...
execute as @e[distance=..5,type=interaction,tag=dryer] store result score @s interact_time run data get entity @s interaction.timestamp
...
execute at @e[distance=..5,type=interaction,tag=interact_target,tag=dryer,limit=1] run function lc2:cook/player/interact_dryer

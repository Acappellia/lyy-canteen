...
advancement revoke @s only lc2:cook/interact_mortar
...
execute as @e[distance=..5,type=interaction,tag=mortar] store result score @s interact_time run data get entity @s interaction.timestamp

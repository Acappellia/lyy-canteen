...
advancement revoke @s only lc2:cook/attack_pot
...
execute as @e[distance=..5,type=interaction,tag=pot] store result score @s interact_time run data get entity @s attack.timestamp
...
execute at @e[distance=..5,type=interaction,tag=interact_target,tag=pot,limit=1] run function lc2:cook/player/attack_pot

...
execute if score $out random matches 2 run playsound minecraft:music.game music @s
...
execute if score $out random matches 3 run playsound minecraft:music.credits music @s
...
execute if score $out random matches 5 run playsound minecraft:music.creative music @s

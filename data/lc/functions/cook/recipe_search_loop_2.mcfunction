...
data modify storage lc:var cookinput.tmp set from storage lc:data recipes[0].in_id_sort
execute store success score #search_recipe_tmpout lc_var run data modify storage lc:data recipes[0].in_id_sort set from storage lc:var cookinput.in_id_sort
data modify storage lc:data recieps[0].in_id_sort set from storage lc:var cookinput.tmp

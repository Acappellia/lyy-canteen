...
execute if score #pot_displaycount lc_var matches 4 run summon item_display ~0.3 ~1 ~ {Tags:["pot_display","new_display"],transformation:[-10,0,0,0,0,0,-10,0,0,-10,0,0,0,0,0,35]}
execute if score #pot_displaycount lc_var matches 5 run summon item_display ~-0.2 ~1 ~0.2 {Tags:["pot_display","new_display"],transformation:[-10,0,0,0,0,0,-10,0,0,-10,0,0,0,0,0,40]}
execute if score #pot_displaycount lc_var matches 6 run summon item_display ~-0.2 ~1 ~-0.2 {Tags:["pot_display","new_display"],transformation:[-10,0,0,0,0,0,-10,0,0,-10,0,0,0,0,0,40]}
execute if score #pot_displaycount lc_var matches 7 run summon item_display ~0.2 ~1 ~-0.2 {Tags:["pot_display","new_display"],transformation:[-10,0,0,0,0,0,-10,0,0,-10,0,0,0,0,0,40]}
execute if score #pot_displaycount lc_var matches 8 run summon item_display ~0.2 ~1 ~0.2 {Tags:["pot_display","new_display"],transformation:[-10,0,0,0,0,0,-10,0,0,-10,0,0,0,0,0,40]}

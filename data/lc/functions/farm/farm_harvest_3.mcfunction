##called when click product slot 3 in farm
...
##get quality
execute if score @s menu_page matches -4 store result score #get_quality lc_var run data get storage lc:user farm[0].farm_page_1[{Slot:22b}].tag.quality
execute if score @s menu_page matches -3 store result score #get_quality lc_var run data get storage lc:user farm[0].farm_page_2[{Slot:22b}].tag.quality
execute if score @s menu_page matches -2 store result score #get_quality lc_var run data get storage lc:user farm[0].farm_page_3[{Slot:22b}].tag.quality
...
execute if score @s menu_page matches -3 run data remove storage lc:user farm[0].farm_page_2[{Slot:22b}]
execute if score @s menu_page matches -2 run data remove storage lc:user farm[0].farm_page_3[{Slot:22b}]

...
execute if score #farm_extra_produce lc_var matches 1.. run data modify block 0 2 0 Items append value {Slot:20,Count:1,id:"minecraft:egg",tag:{menu_ui:1,farm_harvest:1,display:{Name:'{"text":"鸡蛋","color":"gold","italic":false}',Lore:['{"text":"点击收获","color":"yellow","italic":false}']}}}
...
execute if score #farm_extra_produce lc_var matches 1.. run data modify block 0 2 0 Items append value {Slot:21,Count:1,id:"minecraft:egg",tag:{menu_ui:1,farm_harvest:2,display:{Name:'{"text":"鸡蛋","color":"gold","italic":false}',Lore:['{"text":"点击收获","color":"yellow","italic":false}']}}}
...
execute if score #farm_extra_produce lc_var matches 1.. run data modify block 0 2 0 Items append value {Slot:22,Count:1,id:"minecraft:egg",tag:{menu_ui:1,farm_harvest:3,display:{Name:'{"text":"鸡蛋","color":"gold","italic":false}',Lore:['{"text":"点击收获","color":"yellow","italic":false}']}}}

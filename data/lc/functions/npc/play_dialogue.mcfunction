...
##play text
execute unless data storage lc:data npc[0].acts[0].dialogues[0].isplayer unless data storage lc:data npc[0].acts[0].dialogues[0].isbg run tellraw @s [{"text": "-- ","color": "#CCCCCC"},{"nbt":"CustomName","entity": "@e[tag=npc_interact,sort=nearest,limit=1]","interpret": true,"color": "#FFCFF4"},{"text": " --------\n  ","color": "#CCCCCC"},{"nbt":"npc[0].acts[0].dialogues[0].text","storage": "lc:data","interpret": true,"color": "#FF9EBB"}]

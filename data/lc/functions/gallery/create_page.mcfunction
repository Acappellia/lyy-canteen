...
## set a shulker box
setblock 0 2 0 shulker_box{Items:[{Count:1b,Slot:0b,id:"minecraft:dark_oak_sign",tag:{menu_ui:1,BlockEntityTag:{},display:{Name:'{"text":"图鉴收集","color":"#FFBB00","italic":false}'}}},{Count:1b,Slot:18b,id:"minecraft:arrow",tag:{menu_ui:1,display:{Name:'{"text":"上一页","color":"#88FF00","italic":false}'}}},{Count:1b,Slot:26b,id:"minecraft:arrow",tag:{menu_ui:1,display:{Name:'{"text":"下一页","color":"#88FF00","italic":false}'}}}]}

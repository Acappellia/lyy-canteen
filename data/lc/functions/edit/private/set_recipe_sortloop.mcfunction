...
execute store result score #recipe_sorttmp lc_var run data get storage lc:data recipes[0].in_id_sort[0]
...
data modify storage lc:data recipes[0].in_id_sort append from storage lc:data recipes[0].in_id_sort[0]
data remove storage lc:data recipes[0].in_id_sort[0]

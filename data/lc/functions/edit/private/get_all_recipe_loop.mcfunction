...
data modify block 0 2 0 Items append value {Slot:0b,id:"minecraft:knowledge_book",Count:1b,tag:{recipe_unlock:1,display:{Name:'{"text":"料理指南","color":"red","italic":false}'}}}

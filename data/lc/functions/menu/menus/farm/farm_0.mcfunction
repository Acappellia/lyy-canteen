...
data modify block 0 2 0 Items set from storage lc:user farm[0].farm_page_0
...
execute if data block 0 2 0 Items[{Slot:11b}].tag.have_animal run item replace entity @s enderchest.11 from block 0 2 0 container.0 lc:farm/add_info_farm0
item replace block 0 2 0 container.0 from block 0 2 0 container.12
execute if data block 0 2 0 Items[{Slot:12b}].tag.have_animal run item replace entity @s enderchest.12 from block 0 2 0 container.0 lc:farm/add_info_farm0
item replace block 0 2 0 container.0 from block 0 2 0 container.12
execute if data block 0 2 0 Items[{Slot:12b}].tag.have_animal run item replace entity @s enderchest.12 from block 0 2 0 container.0 lc:farm/add_info_farm0
